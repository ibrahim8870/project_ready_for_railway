...
<head>
  ...
  <title>localhost:8001 / localhost | phpMyAdmin 5.2.2</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en_GB&v=5.2.2"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.2.2"></script>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en_GB",server:"1",table:"",db:"",token:"264f456c472921783672445452743966",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:true,arg_separator:"&",version:"5.2.2",auth_type:"cookie",user:"root"});
...
<body>
    <div id="pma_navigation" class="d-print-none" data-config-navigation-width="0">
  ...
  <a href="index.php?route=/table/recent-favorite&db=cafe_pro_db&table=items">
    `cafe_pro_db`.`items`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Y2FmZV9wcm9fZGI=" data-vpath="cm9vdA==.Y2FmZV9wcm9fZGI=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=cafe_pro_db"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=cafe_pro_db" title="Structure">cafe_pro_db</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="264f456c472921783672445452743966">
...
<tr>
  ...
  <td>
          <input type="number" name="NavigationWidth" id="NavigationWidth" value="0" class="custom">
      ...
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap disableAjax" href="index.php?route=/server/status">
              <img src="themes/dot.gif" title="Status" alt="Status" class="icon ic_s_status">&nbsp;Status
                  ...
                  <li class="nav-item">
            <a class="nav-link text-nowrap disableAjax" href="index.php?route=/server/privileges&viewing_mode=server">
